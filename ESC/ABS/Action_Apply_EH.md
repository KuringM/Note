...
temp_apply_grad_mod = temp_apply_grad_mod * Cal.agen_aply_grad_rroad_dbnd_gain[] *100 /1024; //16*1024
...
ABS_whl[].state_apply_gradient_base_s16 = Limit(ABS_whl[].state_apply_gradient_base_s16 + temp_apply_grad_mod,temp_apply_grad_mod / 4, 2^16);
```
