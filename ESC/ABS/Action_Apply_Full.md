...
tmp_app_gradient = Cal.appf_gradient_hi_mu_f/r_1sf // First Cycle
  			    or Cal.appf_gradient_hi_mu_f/r //Other Cycle
...
```c
// last lock torque - now torque
tmp_torq_band_aclfb = ABS_whl[].wheel_lock_torque_0 - ABS_in_whl[].wheel_torque;

if ABS_whl[].aclfb_stab_kommend == 1
{
    tmp_app_torque_delta = tmp_torq_band_aclfb * tmp_full_app_torq_inc_pct /1024;
}
else
{
    tmp_app_torque_delta = ABS_whl[].wheel_torque_band * tmp_full_app_torq_inc_pct /1024;
}
