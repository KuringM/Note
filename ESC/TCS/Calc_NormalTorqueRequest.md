...
Tcs_axle[].brake_torque_compensation = (brake_torque_compensation - Tcs_axle[].brake_torque_compensation) * 										Cal.split_brake_filter_gain + Tcs_axle[].brake_torque_compensation;
